...
//var selection = document.addEventListener()
var Isclicked = false;
...
function highlight() {
    if(Isclicked)
    {
        user_text.style.backgroundColor = "rgba(0, 0, 0, 0.0)";
        Isclicked = false;
        document.getElementById("highlightbtn").style.filter = "none"
    }
    else if( Isclicked = true)
    {
        user_text.style.backgroundColor = "#fff000";
        Isclicked = true;
        document.getElementById("highlightbtn").style.filter = "drop-shadow(rgb(0, 0, 0) 0.2rem 0.2rem 0.2rem)";
    }
}
...
//     else if( Isclicked = true)
//     {
//         var new_text = splitString(user_text, space);
//         user_input = new_text
//         Isclicked = true
